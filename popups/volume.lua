	...
	awful.spawn.easy_async_with_shell(
		...
		function(stdout)
			...
			if volume_level > 80 then
				volume_icon:set_image(beautiful.volume_high)
			elseif volume_level > 40 then
				volume_icon:set_image(beautiful.volume)
			elseif volume_level > 0 then
				volume_icon:set_image(beautiful.volume_low)
			else
				volume_icon:set_image(beautiful.volume_mute)
			end
		end,
		false
	)
